...
// ── FIX: Added null-check on router to prevent crash if called incorrectly ───
export function guardRoute(requiredRole, router) {
  if (typeof window === "undefined") return null;

  // Safety net: if router wasn't passed, fall back to window.location redirect
  if (!router || typeof router.replace !== "function") {
    console.error("guardRoute: router is missing or invalid");
    const roleRoutes = {
