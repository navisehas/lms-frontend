...
export default function PublicCourses() {
  ...
  const uniqueTeachers = useMemo(() => {
    const teacherIds = [
      ...new Set(
        rawCourses.map((c) => String(c.teacher_id)).filter(Boolean)
      ),
    ];
  ...
  const filteredCourses = useMemo(() => {
    return rawCourses
      .filter((c) => {
        ...
        const selected = String(selectedTeacher);

        const tInfo = teachersMap[teacherId] || {};
        ...
        const matchesTeacher =
          selected === "All" || teacherId === selected;
      ...
      .map((c) => {
        ...
        return {
          ...c,
          teacher_name:
            teachersMap[teacherId]?.teacher_name ||
            "Unassigned Teacher",
          teacher_image:
            teachersMap[teacherId]?.profile_picture_url || null,
        };
      });
