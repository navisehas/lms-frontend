...
import {
  ...
  Menu, X, LogOut, Clock, GraduationCap, MessageSquare, Bell, AlertTriangle,User,
} from "lucide-react";
import { guardRoute, logout } from "@/lib/auth";

const BRAND = "#1E40AF";       // emerald-800 equivalent
const BRAND_BG = "#DBEAFE";    // emerald-100 equivalent
  ...
  return (
    ...
    <div className="h-screen w-full bg-gray-50 flex flex-col overflow-hidden relative">
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            <p className="text-gray-600 text-sm mb-6 leading-relaxed">
              Are you sure you want to log out of the Manager Panel? You will need to sign in again to access your account.
            </p>
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        >
          ...
          <div className="md:hidden h-16 flex items-center justify-between px-5 border-b border-blue-700/30 flex-shrink-0">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-lg font-bold tracking-tight">Manager Panel</span>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
        ...
        {/* overflow-y-auto ensures ONLY this inner box scrolls */}
