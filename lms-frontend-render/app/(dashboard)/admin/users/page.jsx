    ...
    <div className="max-w-[1400px] mx-auto p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage students, teachers, and staff.</p>
        </div>
        <Link 
      ...
      <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-col lg:flex-row gap-4 justify-between items-center text-gray-700">
        <div className="relative w-full lg:w-96">
          ...
          <input 
            type="text" placeholder="Search by Name, ID, Phone..." 
            ...
            <table className="w-full text-left whitespace-nowrap md:whitespace-normal">
              <thead className="bg-gray-50 text-gray-500 text-xs uppercase tracking-wider border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-6 py-4 font-bold w-64">Role Details</th>
              ...
              <tbody className="divide-y divide-gray-100 text-sm">
                {filteredUsers.length === 0 ? (
                  <tr><td colSpan="5" className="p-12 text-center text-gray-500 font-medium">No users found matching your criteria.</td></tr>
                ) : (
                  filteredUsers.map((user) => (
                    <tr key={user.user_id} className="hover:bg-blue-50/50 transition">
                      ...
                      <td className="px-6 py-4 whitespace-normal">
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider bg-indigo-50 text-indigo-700 border border-indigo-100 mb-2">
                        ...
                        {user.role === 'TEACHER' && (
                          <div className="text-xs text-gray-700 flex flex-col gap-1 mt-1">
                            <div><span className="font-semibold text-gray-700">Spec:</span> {user.specialization || "N/A"}</div>
                            <div className="line-clamp-2" title={user.description}><span className="font-semibold text-gray-700">Bio:</span> {user.description || "N/A"}</div>
                          </div>
                        )}
                      </td>
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <button onClick={() => setEditingUser(user)} title="Edit User" className="p-2 text-gray-600 bg-gray-50 hover:bg-gray-200 border border-gray-200 rounded-lg transition">
                            <Edit size={16} />
                          </button>
                          <button onClick={() => setDeletingUser(user)} title="Delete User" className="p-2 text-red-600 bg-red-50 hover:bg-red-100 border border-red-200 rounded-lg transition">
                            <Trash2 size={16} />
                          </button>
                        </div>
                      </td>
        ...
        <div style={{ position: "absolute", top: "-9999px", left: "-9999px" }}>
          <div ref={idCardRef} style={{ width: "340px", height: "540px", backgroundColor: "#ffffff", borderRadius: "16px", fontFamily: "sans-serif", position: "relative", overflow: "hidden", boxShadow: "0 4px 6px rgba(0,0,0,0.1)", display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: "100%", padding: "16px 24px", zIndex: 10 }}>
              ...
              <div style={{ backgroundColor: idCardData.role === 'ADMIN' ? '#fee2e2' : idCardData.role === 'TEACHER' ? '#e0e7ff' : '#dcfce3', color: idCardData.role === 'ADMIN' ? '#991b1b' : idCardData.role === 'TEACHER' ? '#3730a3' : '#166534', padding: "4px 16px", borderRadius: "99px", fontSize: "12px", fontWeight: "bold", textTransform: "uppercase", letterSpacing: "1px", marginBottom: "8px" }}>
                {idCardData.role}
              </div>
