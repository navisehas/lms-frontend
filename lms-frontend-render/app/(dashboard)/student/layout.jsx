...
import {
  Menu, X, Home, BookOpen, Calendar, CreditCard,
  User, LogOut, Bell, MessageSquare, GraduationCap, Receipt,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          {/* Logo area — mirrors sidebar brand width on desktop */}
        ...
        {/* Right side — bell + user info + avatar */}
        <div className="flex items-center gap-2 sm:gap-4 ml-auto">
          ...
          <div className="flex items-center gap-3">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-xs font-bold" style={{ color: BRAND }}>Student · {user.user_id}</p>
            </div>
            <div
      ...
      <div className="flex pt-16 min-h-screen">
        ...
        >
          ...
          >
            ...
            <span className="text-lg font-bold tracking-wide text-white">Student Portal</span>
